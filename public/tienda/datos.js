...
const CATEGORIAS = [
  { id: "semis", img: "tienda/img/cat-semis.jpg", nombre: "Esmaltes semis", desc: "Semipermanentes por 15 y 7 ml, y colecciones completas.",
    subs: [{ id: "s15", nombre: "Semis x 15 ml" }, { id: "s7", nombre: "Semis x 7 ml" }, { id: "colec", nombre: "Colecciones" }] },
  { id: "tradicionales", img: "tienda/img/cat-tradicionales.jpg", nombre: "Esmaltes tradicionales", desc: "Secado al aire, tratamientos y top coats.",
    subs: [{ id: "trad", nombre: "Color" }, { id: "trat", nombre: "Tratamientos y top coat" }] },
  { id: "construccion", img: "tienda/img/cat-construccion.jpg", nombre: "Construcción de uñas", desc: "Acrílico, gel, polygel y soft gel.",
  ...
  { id: "decoracion", img: "tienda/img/cat-decoracion.jpg", nombre: "Decoración de uñas", desc: "Stamping, apliques, glitters y gel paint.",
    subs: [{ id: "stamping", nombre: "Stamping" }, { id: "apliques", nombre: "Apliques y efectos" }, { id: "paint", nombre: "Gel paint" }] },
  { id: "herramientas", img: "tienda/img/cat-herramientas.jpg", nombre: "Herramientas y equipos", desc: "Limas, tornos, fresas, cabinas y accesorios.",
  ...
  { id: "preparacion", img: "tienda/img/cat-preparacion.jpg", nombre: "Preparación y removedores", desc: "Primers, deshidratadores, quitaesmaltes y descartables.",
    subs: [{ id: "prep", nombre: "Primers y prep" }, { id: "remo", nombre: "Quitaesmaltes y removedores" }, { id: "desc", nombre: "Descartables" }] },
  { id: "kits", img: "tienda/img/cat-kits.jpg", nombre: "Kits por servicio", desc: "Todo lo de un servicio, armado y con precio cerrado.", subs: [] },
];
...
const PRODUCTOS = [
  ...
  { id:"top-coat-espejo", img:"tienda/img/top-coat-espejo.jpg", cat:"semis", sub:"s15", marca:"Pink Mask", nombre:"Top Coat Brillo Espejo", precio:11800, stock:22, envio:"2 a 4 días",
  ...
  { id:"soft-gel-tips", img:"tienda/img/soft-gel-tips.jpg", cat:"construccion", sub:"soft", marca:"Paris Night", nombre:"Tips Soft Gel Caja x 500", precio:15900, stock:16, envio:"2 a 4 días",
  ...
  { id:"piedras-x1000", img:"tienda/img/piedras-x1000.jpg", cat:"decoracion", sub:"apliques", marca:"City Girl", nombre:"Piedras Surtidas x 1000", precio:8700, stock:20, envio:"2 a 4 días",
  ...
  { id:"lima-100-180", img:"tienda/img/lima-100-180.jpg", cat:"herramientas", sub:"limas", marca:"Opción", nombre:"Lima Recta 100/180 x 10", precio:4200, stock:40, envio:"2 a 4 días",
  ...
  { id:"bloque-pulidor", img:"tienda/img/bloque-pulidor.jpg", cat:"herramientas", sub:"limas", marca:"Opción", nombre:"Bloque Pulidor 4 Caras x 5", precio:3100, stock:35, envio:"2 a 4 días",
  ...
  { id:"fresas-x10", img:"tienda/img/fresas-x10.jpg", cat:"herramientas", sub:"tornos", marca:"Bompassy", nombre:"Set 10 Fresas de Tungsteno", precio:22300, stock:9, envio:"2 a 4 días",
  ...
  { id:"alicate-cuticula", img:"tienda/img/alicate-cuticula.jpg", cat:"herramientas", sub:"acces", marca:"City Girl", nombre:"Alicate Cutícula Acero Inoxidable", precio:14600, stock:6, envio:"2 a 4 días",
